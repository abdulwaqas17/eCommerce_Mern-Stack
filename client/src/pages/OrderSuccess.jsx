...
// // import successImage from '../../assets/success-image.svg'; // Replace with your image path
...
//       <div className="bg-white p-8 rounded-2xl shadow-xl max-w-2xl w-full text-center overflow-hidden relative">
//         {/* Decorative elements */}
...
//               <span className="font-medium text-blue-800">Order #{orderId}</span>
//             </div>
