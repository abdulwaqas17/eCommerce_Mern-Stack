...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    try {
      // Send message to Dialogflow using fetch
      const token = window.localStorage.getItem("userToken");
      const response = await fetch("http://localhost:3000/api/webhook", {
        ...
        body: JSON.stringify({
          query: newMessage,
          sessionId: user._id, // Using user ID as session ID
        }),
      });
      ...
      const errorMessage = {
        text: "Sorry, I'm having trouble connecting to the support team.",
        sender: "bot",
        time: new Date().toLocaleTimeString(),
      };
      ...
      case "chat":
        return (
          <div className="bg-white rounded-lg shadow p-6 h-full flex flex-col">
            ...
            <div className="flex-1 space-y-4 overflow-y-auto mb-4" ref={chatContainerRef}>
