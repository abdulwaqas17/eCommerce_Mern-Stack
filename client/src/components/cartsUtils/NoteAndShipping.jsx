...
<div className="w-full py-6 flex flex-col md:flex-row gap-8">
      ...
      <div className="w-full">
        <label htmlFor="cart-note" className="block text-sm font-medium text-gray-700 mb-2">
          Add Note
        </label>
        <textarea
          id="cart-note"
    ...
    <div>
    <h2 className="text-xl font-medium text-gray-800 mb-2">Get shipping estimates</h2>
