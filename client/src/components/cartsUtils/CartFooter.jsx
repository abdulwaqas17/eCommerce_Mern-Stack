...
const CartFooter = (props) => {
  ...
  return (
    <div className="w-full flex flex-col gap-4 sm:gap-6 rounded-md p-3 sm:p-4 bg-white">
      <div className="rounded-md p-3 sm:p-5 bg-gray-100">
        {/* Subtotal + Tax Note */}
        <div className="flex flex-col gap-1 sm:gap-2">
          ...
          <small className="text-xs text-gray-500 mb-1 sm:mb-2">
            Taxes and shipping calculated at checkout
          </small>
        </div>
