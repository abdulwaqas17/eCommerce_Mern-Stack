          ...
          <div className="flex items-center justify-between py-3">
            ...
            <div className="flex items-center space-x-4 text-gray-500 text-sm">
              <div className="flex items-center">
                ...
                />
                <span>English</span>
                <svg className="w-2 h-2 ml-1" viewBox="0 0 6 4" fill="currentColor">
            ...
            <div className="hidden lg:block text-center text-gray-500 text-sm">
              Free Shipping for all Order of <span className="font-medium">$99</span>
            </div>

            {/* Contact Info */}
            <div className="flex items-center space-x-6 text-gray-500 text-sm">
              <Link to='/' className="flex items-center">
                <svg className="w-4 h-4 mr-2" viewBox="0 0 14 15" fill="currentColor">
              ...
              <Link to='/' className="flex items-center">
                <svg className="w-4 h-4 mr-2" viewBox="0 0 15 11" fill="currentColor">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to='/carts' className="text-black hover:text-green-700 relative">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
